// Core types for drag and drop system
...
export type DragAction = 
  | { type: 'START_DRAG'; payload: { item: DragItem; sourceList: string; originalIndex: number; preview: DragPreview } }
  | { type: 'UPDATE_POSITION'; payload: { dragOverList: string | null; placeholderIndex: number | null } }
  | { type: 'UPDATE_MOUSE'; payload: MousePosition }
  | { type: 'UPDATE_PREVIEW'; payload: DragPreview | null }
  | { type: 'END_DRAG' }
  | { type: 'ADD_CONNECTION'; payload: { itemId: string; connection: ItemConnection } };
