// Core types for the drag-and-drop system
...
export type DragModeConfig = {
  [DragMode.REORDER]: { allowReorder: boolean };
  [DragMode.NO_REORDER]: { allowReorder: false };
  [DragMode.WORDBANK]: { allowMultiple: boolean };
};
